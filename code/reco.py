...
from emotion import index2emotion, expression_analysis, cv2_img_add_text
...
if __name__ == '__main__':
    ...
    model = CNN3()
    path_h5 = '../models/cnn3_best_model_weights.h5'
    path_h5 = os.path.abspath(path_h5)
    model.load_weights(path_h5)
    predict_expression('../DSN/picture/happy2.png', model)
